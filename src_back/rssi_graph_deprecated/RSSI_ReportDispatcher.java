...
// * @author ph4r05
// */
//public class RSSI_ReportDispatcher implements MessageListener {
//  /**
//   * Mote interface
...
//   */
//  public RSSI_ReportDispatcher(MoteIF moteIF) {
//    this.moteIF = moteIF;
//    this.moteIF.registerListener(new MultiPingResponseReportMsg(), this);
...
//    MultiPingResponseReportMsg msg = (MultiPingResponseReportMsg) message;
//    int source = message.getSerialPacket().get_header_src();
//
//    DecimalFormat df = new DecimalFormat("00.000000");
//    System.err.println("Report received; From: " + source + "; Applicable data: "
//            + msg.get_datanum() + "; Message: " + msg.toString());
//
//
////    try {
////        for(int i = 0; i<msg.get_datanum(); i++){
...
////            MobileNode mn = mnm.getMobileNode(msg.get_nodeid()[i], true);
////
...
////                rrr.setCounter(msg.get_nodecounter()[i]);
////                rrr.setNodeID_report_from(source);
////                rrr.setRssi(msg.get_rssi()[i]);
////
...
////
////    } catch (Exception ex) {
////        Logger.getLogger(RSSI_ReportDispatcher.class.getName()).log(Level.SEVERE, null, ex);
////    }
//  }
//
//  /**
