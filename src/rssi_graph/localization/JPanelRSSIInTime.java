/*
 * JPanelRSSIInTime.java
 * To display RSSI with respect to the time
 *
 * Created on Apr 5, 2011, 11:20:57 AM
 */
...
public class JPanelRSSIInTime extends javax.swing.JPanel implements ActionListener {
    ...
    public void logToWindow(String s, int severity){
        this.logToWindow(s, 145, "Localization,RSSIinTime", severity);
    }
    ...
    protected synchronized void updateValues(){
        try {
            ...
            for(int i=0; it.hasNext(); i++){
                ...
                for(int j=0; itAnchor.hasNext(); j++){
                    ...
                    if (!this.timeSeries.containsKey(curTimeSerieKey)){
                        ...
                        ts.setKey(curTimeSerieKey);
                        
                        // regenerate time series later
            ...
            if (redrawGraphNeeded){
                // regenerate time data sets here 
                // according to alphabetical sort
                this.timeDataSets.removeAllSeries();
                ArrayList<TimeSeries> tm = new ArrayList<TimeSeries>(this.timeSeries.size());
                Iterator<String> iterator = this.timeSeries.keySet().iterator();
                while(iterator.hasNext()){
                    tm.add(this.timeSeries.get(iterator.next()));
                }
                
                Collections.sort(tm, new Comparator<TimeSeries>() {
                    public int compare(TimeSeries o1, TimeSeries o2) {
                        return o1.getKey().compareTo(o2.getKey());
                    }
                });
                
                Iterator<TimeSeries> iterator1 = tm.iterator();
                while(iterator1.hasNext()){
                    TimeSeries nextTimeSerie = iterator1.next();
                    this.timeDataSets.addSeries(nextTimeSerie);
                }
            ...
            System.err.println("ExceP: " + e.getMessage());
        }
    }
...
//        this.jPanelDraw.repaint();;
    ...
    private void jToggleGrabItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jToggleGrabItemStateChanged
    ...
    }//GEN-LAST:event_jToggleGrabItemStateChanged
    ...
    private void jTextFieldTimeWindowFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldTimeWindowFocusLost
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_jTextFieldTimeWindowFocusLost

    private void jTextFieldTimeWindowKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldTimeWindowKeyTyped
        // NOTHING FOR NOW
    }//GEN-LAST:event_jTextFieldTimeWindowKeyTyped

    private void jTextFieldTimeWindowKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldTimeWindowKeyReleased
        // null test
        if (this.chartPanel==null) return;
    ...
    }//GEN-LAST:event_jTextFieldTimeWindowKeyReleased
...
//                || this.timeSeries.isEmpty()
        ...
        try {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                writer.writeComment("RSSI in time");
                ...
                while(it.hasNext()){
                    ...
                    while(itemsIt.hasNext()){
                        ...
                        writer.writeRecord( new String[] {
                            ...
                            "#rssi", curDataItem.getValue().toString()
                        });
                    }
                }
