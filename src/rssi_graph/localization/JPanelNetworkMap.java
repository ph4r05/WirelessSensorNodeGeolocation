...
public class JPanelNetworkMap extends javax.swing.JPanel implements NodeRegisterEventListener, ActionListener,
    ...
    public void initThis(){
        ...
        // alter popup menu, attach/dettach
        JMenuItem jMenuItemAttachDettach = new JMenuItem("Attach/Dettach");
        jMenuItemAttachDettach.setActionCommand("attach");
        jMenuItemAttachDettach.addActionListener((ActionListener) this);
        this.chp.getPopupMenu().addSeparator();
        this.chp.getPopupMenu().add(jMenuItemAttachDettach);
...
//            }
    ...
    public synchronized void drawAnchors(){
        ...
        ArrayList<CoordinateRecord> anchorPositions=new ArrayList<CoordinateRecord>();
