        ...
        while(iterator.hasNext()){
            ...
            if (missingCn > 0){
                for(int j=0; j<missingCn; j++){
                    ...
                    sb.append("key;").append(curCategory).append(";").append(0).append(": ").append(rssi_graph.RSSI_graphApp.getLineSeparator());
                }
            }
            ...
            sb.append(rssi_graph.RSSI_graphApp.getLineSeparator());
            lastCategory=curKey;
        }
