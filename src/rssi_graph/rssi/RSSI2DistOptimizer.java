...
public class RSSI2DistOptimizer implements RSSI2DistFunctionOptimizerInterface {
    ...
    /**
     * Whether to optimize constant in RSSI2DistLogNormalShadowing
     */
    private boolean optimizeConstant = true;
    ...
    public double[] optimizeParameters(LinkedList<WeightedObservedPoint> datapoints) throws FunctionEvaluationException, OptimizationException{
        ...
        double[] initialTip = null;
        if (this.isOptimizeConstant()){
            initialTip = new double[2];
            initialTip[0]=0.0;
            initialTip[1]=0.0;
        } else {
            initialTip = new double[1];
            initialTip[0]=0.0;
        }
    ...
    public boolean isOptimizeConstant() {
        return optimizeConstant;
    }

    public void setOptimizeConstant(boolean optimizeConstant) {
        this.optimizeConstant = optimizeConstant;
    }
