 ...
 * 
 * @todo:
 *  - add node liveness indicator (to indicate broken node communication link)
 *  - fullscreenable network map
 *  
 * 
 * 
...
public class RSSI_graphApp extends SingleFrameApplication {
     ...
     * Splash screen uses image from: http://www.purelink.ca/Technologies/RelatedTechnologies.aspx
     */
    ...
    @Override protected void startup() {
        ...
        /**
         * @deprecated
         * do not close splash window since main GUI window will close it automatically
         * when initializes
         */
